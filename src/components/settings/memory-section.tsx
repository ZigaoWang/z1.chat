  ...
  return (
    <div className="space-y-4">
      <p className="text-xs text-muted-foreground">
        {locale === "zh"
          ? "AI 会自动从对话中记住关于你的信息。你也可以手动编辑或用 AI 整理。"
          : "AI automatically remembers things about you from conversations. You can also edit manually or organize with AI."}
      </p>

      {/* Command bar */}
      <div className="flex items-center gap-1.5 rounded-lg border border-border/50 bg-muted/30 dark:bg-muted/20 px-3 py-2.5 focus-within:border-primary/30 focus-within:ring-1 focus-within:ring-primary/10 transition-all">
        <input
          value={chatInput}
      ...
      {chatResult && (
        <p className="text-xs text-muted-foreground/70 px-0.5">{chatResult}</p>
      )}
