export const en = {
  ...
  // Onboarding
  "onboarding.freeCredits": "We've given you ¥7 to start",
  "onboarding.freeCreditsDesc": "That's hundreds of messages — enough to explore everything z1.chat can do.",
  "onboarding.payg": "Top up anytime. Most conversations cost less than ¥0.01.",
  "onboarding.getStarted": "Continue",
  "onboarding.personalize": "Make it yours",
  "onboarding.personalizeDesc": "Pick a look that feels right.",
  "onboarding.chooseAccent": "Accent color",
